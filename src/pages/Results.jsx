...
export default function Results() {
  ...
  return (
    ...
    >
      <div style={{ width: "100%", maxWidth: "365px", display: "flex", flexDirection: "column", alignItems: "center", gap: "40px" }}>
      ...
      {/* --- REVIEW SECTION --- */}
      <div style={{ width: "100%", maxWidth: "min(90vw, 700px)", marginTop: "40px", display: "flex", flexDirection: "column", gap: "14px" }}>
        <h2
          style={{
            fontFamily: "'Edu SA Beginner', cursive",
            fontWeight: 700,
        ...
        {questions && questions.map((q, index) => {
          ...
          return (
            ...
            >
              ...
              {/* Divider */}
              <div style={{ height: "1px", backgroundColor: "#D6E4F9", margin: "8px 0 8px -32px" }} />
              ...
              {!isCorrect && (
                <p style={{
                  ...
                  <span style={{ fontWeight: 600, opacity: 0.55, fontSize: "14px" }}>Answer: </span>
              ...
              >
                {isCorrect ? (
                  <svg style={{ width: 14, height: 14 }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                ) : (
                  <svg style={{ width: 14, height: 14 }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
                )}
